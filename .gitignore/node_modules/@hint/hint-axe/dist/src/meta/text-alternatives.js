...
const meta = {
    ...
    schema: [
        ...
        {
            items: {
                enum: ['area-alt', 'document-title', 'frame-title', 'frame-title-unique', 'image-alt', 'image-redundant-alt', 'input-image-alt', 'object-alt', 'role-img-alt', 'server-side-image-map', 'svg-img-alt', 'video-caption', 'video-description'],
                type: 'string'
            },
            typeof: 'array',
            uniqueItems: true
