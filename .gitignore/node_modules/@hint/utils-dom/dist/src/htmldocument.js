...
class HTMLDocument extends node_1.Node {
    ...
    querySelector(selector) {
        const data = cssSelect.selectOne(get_compiled_selector_1.getCompiledSelector(selector), this._document.children);
        return data ? this.getNodeFromData(data) : null;
    }
    querySelectorAll(selector) {
        const matches = cssSelect(get_compiled_selector_1.getCompiledSelector(selector), this._document.children);
