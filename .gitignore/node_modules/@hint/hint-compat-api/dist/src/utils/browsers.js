...
exports.filterBrowsers = (browsers) => {
...
exports.formatSupported = (browser, versionAdded, versionRemoved) => {
...
exports.formatUnsupported = (browser, versionAdded, versionRemoved) => {
    const browserName = utils_compat_data_1.getFriendlyName(browser);
    if (versionAdded && versionRemoved) {
...
exports.joinBrowsers = (unsupported) => {
