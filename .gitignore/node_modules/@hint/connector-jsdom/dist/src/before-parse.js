...
exports.beforeParse = (finalHref) => {
    return (window) => {
        const mutationObserverPolyfill = utils_fs_1.readFile(require.resolve('mutationobserver-shim'));
        const customElementsPolyfill = utils_fs_1.readFile(path.join(__dirname, 'polyfills', 'custom-elements.min.js'));
